/*
 ...
 Source Server         : 39.107.119.69
 Source Server Type    : MySQL
 Source Server Version : 50639
 Source Host           : 39.107.119.69
...
CREATE TABLE `constant` (
  `total_seconds` int(11) DEFAULT '120' COMMENT '卷帘完全关闭的时间',
...
CREATE TABLE `control` (
  ...
  `c_order_less` int(11) DEFAULT '0',
  `is_running` int(11) NOT NULL DEFAULT '2',
  `open_lev` int(11) DEFAULT '-2',
  PRIMARY KEY (`ctrl_id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;

-- ----------------------------
--  Table structure for `ctrl_log`
-- ----------------------------
DROP TABLE IF EXISTS `ctrl_log`;
CREATE TABLE `ctrl_log` (
  `ctrl_log_id` int(11) NOT NULL AUTO_INCREMENT,
  `ctrl_id` int(11) DEFAULT NULL COMMENT 'log，有可能ctrl修改后，与log时的不一致，此处先不作处理',
  `ctrl_type` int(11) DEFAULT '0' COMMENT '1、2 卷帘、继电器',
  `ctrl_act` int(11) NOT NULL DEFAULT '-10' COMMENT '-1 、0 代表开关的开和关，1、2、3，代表卷帘的上升、下降、停止',
  `ctrl_from` int(11) DEFAULT '0' COMMENT '1,2,3:自动控制、预约控制、智能控制',
  `ctrl_time` datetime DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`ctrl_log_id`)
) ENGINE=InnoDB AUTO_INCREMENT=182324 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `distribution` (
  ...
  `d_originalname` varchar(255) DEFAULT NULL,
  `d_filename` varchar(225) DEFAULT NULL,
  `d_procedure` int(11) DEFAULT '0',
  `is_special` int(11) DEFAULT '0',
  `data_time` varchar(255) DEFAULT NULL COMMENT '数据时间，统计的时间 yyyy-MM-dd ',
  PRIMARY KEY (`d_id`)
) ENGINE=InnoDB AUTO_INCREMENT=149 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;

-- ----------------------------
--  Table structure for `exp_ans`
-- ----------------------------
DROP TABLE IF EXISTS `exp_ans`;
CREATE TABLE `exp_ans` (
  `exp_ans_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`exp_ans_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='专家答疑';

-- ----------------------------
--  Table structure for `exp_client`
-- ----------------------------
DROP TABLE IF EXISTS `exp_client`;
CREATE TABLE `exp_client` (
  `exp_client_id` int(11) NOT NULL AUTO_INCREMENT,
  `exp_id` int(11) DEFAULT NULL,
  `tu_id` int(11) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `if_delete` int(11) DEFAULT '0',
  PRIMARY KEY (`exp_client_id`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
--  Table structure for `exp_field`
-- ----------------------------
DROP TABLE IF EXISTS `exp_field`;
CREATE TABLE `exp_field` (
  `exp_field_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '专家领域id',
  `c_id` int(11) DEFAULT NULL COMMENT '专家分类id',
  `tu_id` int(11) DEFAULT NULL COMMENT '用户id',
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`exp_field_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
--  Table structure for `exp_pro`
-- ----------------------------
DROP TABLE IF EXISTS `exp_pro`;
CREATE TABLE `exp_pro` (
  `exp_pro_id` int(11) NOT NULL AUTO_INCREMENT,
  `exp_pro_title` varchar(255) DEFAULT NULL,
  `exp_pro_content` text,
  `create_time` datetime DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `tu_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`exp_pro_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='专家服务项目';
...
CREATE TABLE `input` (
  ...
  PRIMARY KEY (`in_id`)
) ENGINE=InnoDB AUTO_INCREMENT=77 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `message` (
  ...
  `m_source` int(11) DEFAULT '1' COMMENT '1，2 ：系统咨询，专家咨询',
  `m_author_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB AUTO_INCREMENT=384 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `role` (
  ...
  `r_cname` varchar(32) DEFAULT NULL,
  `r_id` int(11) NOT NULL AUTO_INCREMENT,
  `menu_ids` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`r_id`)
...
CREATE TABLE `t_monitor` (
  ...
  `mo_state` int(4) DEFAULT NULL COMMENT '控制状态正常1，不正常2',
  ...
  `order_less` int(11) DEFAULT '1' COMMENT '2关闭1开启',
  `order_more` int(11) DEFAULT '2' COMMENT '2关闭1开启',
  `check_interval` int(11) DEFAULT '5' COMMENT '间隔多长时间检查一次 m',
  `duration` int(11) DEFAULT '120' COMMENT '控制时长s',
  PRIMARY KEY (`mo_id`)
...
CREATE TABLE `t_point` (
  ...
  PRIMARY KEY (`tp_id`)
) ENGINE=InnoDB AUTO_INCREMENT=158 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_user` (
  ...
  `tu_info` text COMMENT '简介 主要针对专家用户',
  `tu_age` int(11) DEFAULT NULL COMMENT '年龄',
  `tu_logo` varchar(255) DEFAULT NULL COMMENT '头像',
  `tu_province` varchar(32) DEFAULT NULL COMMENT '用户所在省',
  `tu_city` varchar(32) DEFAULT NULL COMMENT '用户所在市',
  `tu_district` varchar(32) DEFAULT NULL COMMENT '用户所在地区',
  PRIMARY KEY (`tu_id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=4079 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002118` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=5075 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002119` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=2673 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002121` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=537 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002122` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=125358 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002124` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=114437 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002126` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=5479 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002127` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=114712 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002128` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=2127 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002130` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=3629 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002132` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=3890 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002133` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=5140 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002173` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=3165 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_devicestatus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=872 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_img` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=151289 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_ipc` (
  ...
  `status` int(50) DEFAULT NULL COMMENT '摄像头状态',
...
) ENGINE=InnoDB AUTO_INCREMENT=12236 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `user_question` (
  ...
  `if_delete` int(11) DEFAULT '0',
  `q_ans` text,
  `q_state` int(11) DEFAULT '2' COMMENT '2:待审核1：审核通过',
