...
CREATE TABLE `T_VARTRIVER_Monitor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=742 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='专家服务项目';
...
CREATE TABLE `input` (
  ...
  PRIMARY KEY (`in_id`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB AUTO_INCREMENT=361 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_10002122` (
  ...
  PRIMARY KEY (`id`),
  KEY `T_VARTRIVER_10002045_index_infoDataTime` (`infoDataTime`)
) ENGINE=InnoDB AUTO_INCREMENT=110875 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_img` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=139952 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
