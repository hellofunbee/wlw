...
) ENGINE=InnoDB AUTO_INCREMENT=2298 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='专家服务项目';
...
CREATE TABLE `message` (
  ...
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB AUTO_INCREMENT=382 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_vartriver_img` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=148815 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
