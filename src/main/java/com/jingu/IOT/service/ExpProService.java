...
import com.jingu.IOT.dao.ExpProDao;
 ...
 */
@Component
public class ExpProService {

    @Autowired
    ExpProDao expProDao;

    public IOTResult save(PageData pd) {
        int back = expProDao.save(pd);
    ...
    public IOTResult list(PageData pd) {
        List<Map<String, Object>> back = expProDao.list(pd);
