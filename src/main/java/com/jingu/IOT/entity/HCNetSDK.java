...
//Native.loadLibrary("HCNetSDK",HCNetSDK.class);
//	NativeLibrary.addSearchPath(RuntimeUtil.getLibVlcLibraryName(), "");

    /***宏定义***/
    //常量

    public static final int DEVICE_ENCODE_ALL_ABILITY_V20 = 0x008;
...
//2007-11-30 V211支持以下接口 //11
    ...
    //能力集
    boolean NET_DVR_GetDeviceAbility(NativeLong lUserID, int dwAbilityType, String pInBuf, int dwInLength, Memory pOutBuf, int dwOutLength);
