...
var typeArr = [{
    ...
    img01: './img/co2_front.svg',
    img02: './img/co2_back.svg'
}, {
    img01: './img/temperature_front.svg',
    img02: './img/temperature_back.svg'
}, {
    img01: './img/humidity_pointer.svg',
    img02: './img/humidity_dashboard.svg'
}]
$(function () {
    listPoint();
    /*初始化页面*/
            ...
            if (data.state == 0) {
                ...
                $(data.object.unit).each(function (i, el) {
                    ...
                    if (data.object.unit[i].chartID == 3) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) +
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/Rainfall_F.svg" alt="" style="z-index: 2"> <img src="./img/sensor/Rainfall_B.svg" alt=""></div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    }
                    //风向 4  16种
                    if (data.object.unit[i].chartID == 4) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/Weathercock_F.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/Weathercock_B.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    }
                    //风速5 0-32.4m/s
                    if (data.object.unit[i].chartID == 5) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/Windspeed_F.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/Windspeed_B.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    }
                    //na 9 氮肥
                    if (data.object.unit[i].chartID == 9) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/N_F.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/N_B.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 10) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/ka_F.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/ka_B.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 11) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/co2_front.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/co2_back.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 12) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/o2_B.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/o2_F.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 13) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/pH_F.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/pH_B.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 1 || data.object.unit[i].chartID == 8) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><div class="bg"></div><img src="./img/sensor/temperature_front.svg" alt="" style="z-index: 2;"> <img src="./img/sensor/temperature_back.svg" alt=""> </div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 2 || data.object.unit[i].chartID == 7) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><img src="./img/sensor/humidity_pointer.svg" alt="" style="z-index: 2;top:.25rem"> <img src="./img/sensor/humidity_dashboard.svg" alt=""></div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                    ...
                    if (data.object.unit[i].chartID == 6) {
                        str += '<li data-t=' + data.object.unit[i].chartID + ' data-num=' +
                            ...
                            ' class="menu_e_listinfo"><p class="menu_e_l_t">' + data.object.unit[i]
                            .name +
                            '</p><div class="menu_e_l_pic"><img src="./img/sun.svg" alt="" style="z-index: 2"></div><p class="menu_e_l_b">' +
                            picNumber(data.object.unit[i].fieldName, data.object.data[0]) + data.object
                            .unit[i].unit + '</p></li>'
                ...
                $('.menu_data_bg>li').each(function (i, el) {
                    ...
                    if ($(this).attr('data-t') == 2 || $(this).attr('data-t') == 7) {
                        ...
                        $(this).find('img').eq(0).rotate({
                            animateTo: h2,
                            duration: 2000
                        });
                    }
                    //雨量
                    if ($(this).attr('data-t') == 3 || $(this).attr('data-t') == 9 || $(this).attr(
                            'data-t') == 10 || $(this).attr('data-t') == 12 || $(this).attr(
                            'data-t') == 13) {
                        var h = 120;
                        var maxh = 100;
                        var h2;
            ...
            if (data.state == 0) {
                ...
                if (data.object != null) {
                    ...
                    $(data.object.data).each(function (j, e) {
                        ...
                        time += '<td class="menu_e_fir_datas">' + getTime(dataList.infoDataTime) +
                            '</td>'
                    });
                    ...
                    $(data.object.unit).each(function (a, el) {
                        ...
                        $(data.object.data).each(function (j, e) {
                            var dataList = data.object.data[j];
                            str += '<td>' + dataList[arr[a]] + data.object.unit[a].unit +
                                '</td>'
                        })
                        str += '</tr>'
                    ...
                    var top = $('.menu_e_l_top').height() + $('.page_bg').height() + $('.menu_e_act_out').height() /
                        2;
                    $('.rigntMores').css('top', top).show();
                    $('.menu_e_act_bg').scroll(function () {
                        var lastW = $('.menu_e_actial tr>td').width() * 4
                        if ($('.menu_e_act_bg').scrollLeft() + lastW - $('.menu_e_actialout').width() >=
                            0) {
                            $('.rigntMores').hide()
                        } else {
                            $('.rigntMores').show()
        ...
        success: function (data) {
            ...
            if (data.state == 0) {
                if (data.object != null) {
                    ...
                    $('#shipin01').attr('src', './demo.html').addClass('fiexleft').removeClass('fiexright')
                        .show()
                    setTimeout(function () {
            ...
            if (data.state == 0) {
                ...
                if (data.object.length == 0) {
                    ...
                    $(data.object).each(function (i, el) {
                        $('.shexiangtoujsdList1').append("<li data-monitorId=" + data.object[i].monitorId +
                            ">" + data.object[i].monitorName + "</li>")
                    })
    ...
    $.ajax({
        ...
        success: function (data) {
			...
			if (data.state == 0) {
                ...
                var nums = 0;
                $(data.object).each(function (i, el) {
                    str += '<div class="points"><p class="treeleft_head">' + data.object[i].tp_name +
                        '</p>'
                    $(data.object[i].rank).each(function (l, el) {
                        str +=
                            '<ul class="treeleft_second"><li class="treeleft_student"><span class="leftTops"></span><span class="leftLies">' +
                            data.object[i].rank[l].tp_name +
                            '</span><ul class="treeleft_stu_lists">'
                        $(data.object[i].rank[l].rank).each(function (y, el) {
                            nums++;
                            str +=
                                '<li class="treeleft_stu_menu"><span class="treeleft_stu_m_lline"></span><div class="treetwo"><img src="./img/treen/online.png" class="treetwoImg"/><span class="treeleft_stu_m_name" data-tp_id="' +
                                data.object[i].rank[l].rank[y].tp_id +
                                '" data-supervisername=" ' + data.object[i].rank[l]
                                .rank[y].supervisername +
                                '"data-state="' + data.object[i].rank[l].rank[y].state +
                                '" data-producername="' + data.object[i].rank[l].rank[
                                    y].producername + '" nums="' + nums +
                                '" data-name=" ' + data.object[i].rank[l].rank[y].name +
                                '" data-exportorname=" ' +
                                data.object[i].rank[l].rank[y].exportorname +
                                '" data-x="' + data.object[i].rank[l].rank[y].x +
                                '" data-y="' + data.object[i].rank[l].rank[y].x +
                                '" data-deviceId="' +
                                data.object[i].rank[l].rank[y].deviceId +
                                '" data-ip="' + data.object[i].rank[l].rank[y].ip +
                                '" data-port="' + data.object[i].rank[l].rank[y].port +
                                '">' +
                                data.object[i].rank[l].rank[y].tp_name +
                                '</span></div><ul class="treeleft_stu_cameras">'
                    ...
                    $('.treetwo').each(function () {
                        if ($(this).find('.treeleft_stu_m_name').attr('data-state') == 2) { //2不在线
                            $(this).find('img').attr('src',
                                './img/shexiang/ico_disconnect.png');
                            $(this).find('.treeleft_stu_m_name').addClass('noline').removeClass(
                                'online')
                        } else {
                            $(this).find('img').attr('src', './img/shexiang/ico_device.png');
                            $(this).find('.treeleft_stu_m_name').addClass('online').removeClass(
                                'noline')
                        }
                    })
                    ...
                    if (getUrlKey('num')) {
                        ...
                        $('.treeleft_second:eq(0)').find('.treeleft_student:eq(0)').find(
                            '.treeleft_stu_lists').find('.treeleft_stu_menu:eq(0)').find(
                            '.treetwo:eq(0)').find('.treeleft_stu_m_name').click();
                    }
                    $('.treeleft_stu_cameras').find('.treeleft_stu_camera:eq(0)').addClass(
                        'treeleft_stu_camera_first');
                    /*切换摄像头*/
                    /*active().click();*/
...
function getUrlKey(name) {
    return decodeURIComponent((
        new RegExp('[?|&]' + name + '=' + '([^&;]+?)(&|#|;|$)').exec(location.href) || [, ""])[1].replace(/\+/g,
        '%20')) || null;
};
...
function appAndroid() {
    ...
    if (browser.versions.iPhone || browser.versions.iPad || browser.versions.ios) {
        getDeviceIDiOS(active().parents('.treetwo').siblings('.treeleft_stu_cameras').find('.treeleft_stu_camera').eq(0)
            .attr('data-deviceid'), 0, 0, 0, 0);
    }
    if (browser.versions.android) {
        window.AndroidView.showView(active().parents('.treetwo').siblings('.treeleft_stu_cameras').find(
            '.treeleft_stu_camera').eq(0).attr('data-deviceid'), 0, 0, 0, 0);
    }
}
