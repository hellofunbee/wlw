                    ...
                    for (var a = 0; a < data.object.length; a++) {
                        ...
                        for (var b = 0; b < data.object[a].list.length; b++) {
                            ...
                            str += '<li class="fir_var_l_num"><a href="./proDetail.html?m_id=' + data.object[
                                    a].list[b].m_id +
                                '&title=文章详情" target="_self" ><div class="fir_var_l_n_top clear"><img class="fir_var_l_n_img fl" src="http://servera.jianghujoy.com:8087/' +
            ...
            if (data.state == 0) {
                ...
                $(data.object).each(function (i, el) {
                    ...
                    $('.swiper-wrapper').append(" <div class='swiper-slide'><img data-src=" + data.object[
                        i].h_url + " src=http://servera.jianghujoy.com:8087/" + data.object[i].h_cover + " alt=''></div>")
					/* $('.swiper-wrapper').append(" <div class='swiper-slide'><img data-src=" + data.object[
