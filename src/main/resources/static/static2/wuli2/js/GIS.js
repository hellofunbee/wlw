	...
	function addMapOverlay(title,shiyongzhe,zhidaozhuanjia,shengchanzhe,yunxingzhuangtai,guanlizhe,num,deviceIds){
       ...
       if(yunxingzhuangtai==1){
        ...
        "</ul>"+
          ...
          "<li class='info_1' onclick='go(1,"+num+")' style='float: left;width:.525rem;height:.175rem;margin:0 .056rem .112rem 0;text-align:center;color:#3BA9ED;font-size: .0875rem;border: 1px solid #0E64AD;box-sizing: border-box;border-radius: .025rem;cursor:pointer'>综合信息</li>" +
          "<li class='info_2' onclick='secondClick(\""+deviceIds+"\")' style='float: left;width:.525rem;height:.175rem;margin:0 .056rem .112rem 0;text-align:center;color:#3BA9ED;font-size: .0875rem;border: 1px solid #0E64AD;box-sizing: border-box;border-radius: .025rem;cursor:pointer'>视频信息</li>"+
          "<li class='info_3' onclick='go(3,"+num+")' style='float: left;width:.525rem;height:.175rem;margin:0 .056rem .112rem 0;text-align:center;color:#3BA9ED;font-size: .0875rem;border: 1px solid #0E64AD;box-sizing: border-box;border-radius: .025rem;cursor:pointer'>图片信息</li>" +
          "<li class='info_4' onclick='go(4,"+num+")' style='float: left;width:.525rem;height:.175rem;margin:0 .056rem .112rem 0;text-align:center;color:#3BA9ED;font-size: .0875rem;border: 1px solid #0E64AD;box-sizing: border-box;border-radius: .025rem;cursor:pointer'>即时信息</li>" +
          "<li class='info_5' onclick='go(5,"+num+")' style='float: left;width:.525rem;height:.175rem;margin:0 .056rem .112rem 0;text-align:center;color:#3BA9ED;font-size: .0875rem;border: 1px solid #0E64AD;box-sizing: border-box;border-radius: .025rem;cursor:pointer'>生产管理</li>" +
           "<li class='info_5' onclick='go(6,"+num+")' style='float: left;width:.525rem;height:.175rem;margin:0 .056rem .112rem 0;text-align:center;color:#3BA9ED;font-size: .0875rem;border: 1px solid #0E64AD;box-sizing: border-box;border-radius: .025rem;cursor:pointer'>专家系统</li>" +
         "</ul>"+
          "</div>";
          	           // 将标注添加到地图中
       		return sContent;
									...
									if(data.state == 0) {
										if(data.object!=null){
											...
											$(data.object).each(function(i, el) {
												$('.searchwar_List').append("<li data-content=" + data.object[i].m_content + ">" + data.object[i].province + data.object[i].city + data.object[i].district + "</li>")
											})
											$('.searchwar_List>li').on('click', function() {
												...
												d_createMap();
												getBoundary($(this).text(), '-1', $(this).attr('data-content'),1);
												//滚动
