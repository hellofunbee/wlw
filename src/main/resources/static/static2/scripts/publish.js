            ...
            if(data.success){
                    ...
                    for(var i=0;i<data.object.length;i++){
                        ...
                        str+=" <li class='zhengceTop zhengceTopid' dataid='"+data.object[i].c_id+"'><div class='top'> <div class='heng fl'></div> <img src='img/lingxing.png' alt=''/> <span >"+data.object[i].c_name+"</span> <img class='imgRigh' src='img/lingxing.png' alt=''/> <div class='heng fl'><div class='policeknowMore policeknowMoreid'>了解更多&gt;</div></div> </div> <ul class='content con2'>"
                            ...
                            str+='<li><div class="info"><div class="pd fl"><div style="background: url('+data.object[i].list[j].m_cover+')no-repeat center;background-size: cover" class="picture"></div><p class="per">'+data.object[i].list[j].m_authorname+'</p><p class="date">'+dealdata(data.object[i].list[j].m_time)+'</p></div><div class="detail fl"><p class="tit">'+titlea+'</p><p class="read">'+data.object[i].list[j].m_content+'</p></div><div class="more2"><a style="font-size: 0.14rem" href="./consulting.html?m_id='+data.object[i].list[j].m_id+'&title=政策信息" target="_blank">了解更多&gt;</a></div></div></li>'
                       	 }
                        str+='</ul></li></div>';
                        $("#a1").append(str);
