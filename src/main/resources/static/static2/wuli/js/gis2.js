...
function windowinfo(lng,lat,index,html){
    if(index!='-1'){
        ...
        $(rootData[index].d_content).each(function(i,el){
            ...
            str+="<p style='color: #02265A;font-size: .075rem;line-height: .15rem'><span style='display: inline-block;width:.1rem;line-height: .15rem'>"+(i+1)+". </span> <span style='display: inline-block;width: .5rem;line-height: .15rem'>"+rootData[index].d_content[i].d_content+"</span><span style='color:#0E64AD;width:41px;display:inline-block;text-align:right;'>"+rootData[index].d_content[i].d_value+"</span></p>"
        })
